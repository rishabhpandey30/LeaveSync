...
const AllReimbursements = () => {
    ...
    return (
        <div className="page-container p-4 md:p-6 mx-auto">
            <h1 className="text-2xl font-bold mb-6 text-slate-800 dark:text-white">All Company Claims</h1>
                            ...
                            {reimbursements.map(r => (
                                <tr key={r._id} className="hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <td className="py-4 px-6">
                                        ...
                                        {r.reviewedBy && (
                                            <p className="text-[10px] text-slate-400 mt-1.5 truncate max-w-[120px]">
